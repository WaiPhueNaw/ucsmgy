...
class DetailSubCsPage extends StatelessWidget {
  const DetailSubCsPage({super.key});
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> second_sec = [
      ...
      'Web Technology, Java Script Programming',
    ...
    final List<String> third = [
      ...
      'Skills & knowledge (II) . Web Development PHP',
