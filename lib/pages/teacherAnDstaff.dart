...
class TeacherandStaffPage extends StatelessWidget {
  TeacherandStaffPage({super.key});

  final Color tColor = Colors.blue;
  final Color sColor = Colors.amber;
  ...
  Widget build(BuildContext context) {
    final List<BarChartGroupData> studentData = [
      BarChartGroupData(
        x: 0,
        barRods: [BarChartRodData(toY: 53, color: tColor),
        BarChartRodData(toY: 43, color: sColor),],
        showingTooltipIndicators: [0],
      ),
      BarChartGroupData(
        x: 1,
        barRods: [
          BarChartRodData(toY: 55, color: tColor),
          BarChartRodData(toY: 51, color: sColor),
        ],
      ),
      BarChartGroupData(
        x: 2,
        barRods: [
          BarChartRodData(toY: 53, color: tColor),
          BarChartRodData(toY: 50, color: sColor),
        ],
      ),
      BarChartGroupData(
        x: 3,
        barRods: [
          BarChartRodData(toY: 52, color: tColor),
          BarChartRodData(toY: 53, color: sColor),
        ],
      ),
      BarChartGroupData(
        x: 4,
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              const Text(
                                '၂၀၂၁ ခုနှစ်မှ ၂၀၂၅ ခုနှစ်ထိ ဝန်ထမ်းအင်အား',
                                style: TextStyle(
                                  fontSize: 14,
                                  //fontWeight: FontWeight.bold,
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          _buildLegendItem(tColor, 'ဒုတိယပါမောက္ခချုပ်နှင့်ဆရာ၊ဆရာမ များ'),
                          _buildLegendItem(sColor, 'စီမံခန့်ခွဲရေးဝန်ထမ်း များ'),
